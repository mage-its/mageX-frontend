  ...
  return (
    <main className="bg-purple-orange relative min-h-screen overflow-hidden">
      <div className="relative z-10">
        <img
          src={pz_top_l}
          className="absolute select-none inset-0 mobile:mt-[-6.5rem] mobile:left-[-12rem] mobile:scale-[0.5] ipad:mt-[-6.5rem] ipad:left-[-12rem] ipad:scale-[0.5] desktop:left-[-10rem] desktop:scale-[1.2] desktop:mt-[-8rem]"
        />
        <img
          src={pz_top_r}
          className="absolute select-none mobile:mt-[-6rem] mobile:right-[-8.5rem] mobile:scale-[0.5] ipad:mt-[-6rem] ipad:right-[-8.5rem] ipad:scale-[0.5] desktop:right-[-5rem] desktop:scale-[1.2] desktop:mt-[-7rem]"
        />
        <Navbar />
        <PCBBg />
        <WorkshopText />
