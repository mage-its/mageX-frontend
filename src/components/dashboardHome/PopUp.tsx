...
const Popup: React.FC<PopupProps> = ({ isVisible, onClose, destination }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="relative bg-transparent_black rounded-[2rem] font-fredoka text-light text-center drop-shadow-lg select-none
        ...
        <p className="mt-4">You will be registered as
            <span
                style={{
                    position: 'absolute',
                    color: 'transparent',
