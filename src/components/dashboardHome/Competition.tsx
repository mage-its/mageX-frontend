  ...
  useEffect(() => {
    const updateContainerWidth = () => {
      if (containerRef.current) {
        ...
        console.log('Container Width:', width); // Debugging output
  ...
  return (
    <div className="h-full
      ...
      <div className="flex p-4 items-center select-none bg-gray-5 mobile:rounded-t-[1rem] ipad:rounded-t-[2rem]
        ...
        <img src={TrophyLogo} className="select-none mobile:w-[2rem] mobile:h-[2rem] ipad:w-[2rem] ipad:h-[2rem] desktop:w-5 desktop:h-5"/>
        <h2 className="text-light font-fredoka mx-[1rem] select-none
                       mobile:text-[23px] ipad:text-[23px] desktop:text-[1rem]">Competitions</h2>
        <img src={Seven} className="select-none mobile:w-[2rem] mobile:h-[2rem] ipad:w-[2rem] ipad:h-[2rem] desktop:w-5 desktop:h-5"/>
      </div>
