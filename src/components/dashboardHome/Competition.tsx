  ...
  return (
    <div className="w-full h-full">
      <div className="flex p-4 items-center h-[3rem] select-none bg-gray-5">
        <img src={TrophyLogo} className="w-5 h-5 select-none" />
        <h2 className="text-light font-fredoka text-[1rem] mx-[1rem] select-none">Competitions</h2>
        <img src={Seven} className="w-5 h-5 select-none" />
      </div>
