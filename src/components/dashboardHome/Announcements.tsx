...
const Announcement: React.FC<{ announcement: AnnouncementProps }> = ({ announcement }) => {
    return (
        <div className="p-4 font-fredoka overflow-hidden">
...
const AnnouncementsList: React.FC<{ announcements: AnnouncementProps[] }> = ({ announcements }) => {
    ...
    return (
        <div className="w-full h-full overflow-hidden flex-col rounded-[2rem] shadow-lg select-none">
            <div className="flex p-4 w-full h-[4rem] items-center select-none bg-gray-1">
            ...
            <div ref={scrollRef} className="p-4 flex-1 h-[90%] w-full bg-transparent_black overflow-auto custom-scroll no-scrollbar" style={{ cursor: 'grab' }}>
...
const App: React.FC = () => {
    const announcements: AnnouncementProps[] = [
        { id: 1, title: 'Lorem Ipsum 1', content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna awdadawdaaaaaaaaaaaaaaaaaaaaaaaa', date: '04 April 2024 7:29 PM' },
