...
const SummaryList: React.FC<{ competitions: CompetitionProps[], workshops: WorkshopProps[] }> = ({ competitions, workshops }) => {
    ...
    return (
        <div className="overflow-hidden rounded-[2rem] w-full h-full shadow-lg select-none">
            <div className="flex p-4 items-center select-none bg-gray-1">
                <img src={Logo} className="mr-2 w-6 h-6 select-none" alt="Summary Logo" />
