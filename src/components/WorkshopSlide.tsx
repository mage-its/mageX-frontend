...
const WorkshopSlide = () => {
  ...
  {
    mobileContent.push(
    <div className="flex-col transition-colors duration-1000 ease-in items-center w-full h-[105vh] overflow-hidden rounded-2xl border-8 relative"
          ...
          <div className="flex h-[90%] transition-transform duration-1000 w-full"
            ...
            {slides.map((slide, index) => (
              <div className="w-full flex-shrink-0 p-5 box-border flex" key={index}>
                <div className="w-[55%] mt-[4rem] mb-[2.5rem] flex flex-col justify-center">
                  {/* Title */}
                  ...
                  <div className="ml-[1rem] text-gray font-fredoka p-5 rounded mb-[4rem] w-full">
                    {/* Content */}
                    <div className="text-gray-800 text-base mb-2">{slides[i].content}</div>
                    {/* Location and time */}
                    <div className="flex">
                  ...
                  <div
                    className="inset-0 p-1 rounded-[0.5rem] mx-auto w-[25rem] mt-[7rem] h-[4rem]"
                    style = {{ background: slides[i].color3 }}
                  >
                    <button
                      className="relative m-auto bg-light text-center text-[1.5rem] w-full h-full font-bold py-2 px-4 rounded-[0.4rem]"
                      style={{ color: slides[i].color1, borderColor: slides[i].color2 }}
                    >
                      Daftar sekarang!
                    </button>
                  </div>
                ...
                <div className="w-[40%] mb-[10%] flex items-center justify-center">
                  {/* Placeholder for image*/}
                  <div className="w-full h-full mx-[10%] mt-[20%] bg-white flex items-center justify-center rounded-[2rem]">
                    <span
                      className="text-9xl"
                      style={{ color: slides[i].color1 }}
                    >
                  ...
                  <div
                    className="absolute top-[35rem] text-white font-bold py-2 px-4 rounded-[1.5rem] text-center w-[35%]"
            ...
            {slides.map((slide, index) => (
              <div className="w-full flex-shrink-0 p-5 box-border flex" key={index}>
                <div className="w-[55%] mt-[4rem] mb-[2.5rem] flex flex-col justify-center">
                  ...
                  <div className="ml-[1rem] text-gray font-fredoka p-5 rounded mb-[4rem] w-full">
                    {/* Content */}
                    <div className="text-gray-800 text-base mb-2">{slides[index].content}</div>
                    {/* Location and time */}
                    <div className="flex">
                      <div className="flex items-center w-[50%]">
                        <img
                          src={ slides[index].locationIcon }
                        />
                        <span
                          className="ml-2 text-[1.5rem]"
                          style = {{ color: slides[index].color1 }}
                        >
                          {slide.subtext1}
                        </span>
                      </div>
                  ...
                  <div
                    className="inset-0 p-1 rounded-[0.5rem] mx-auto w-[25rem] mt-[7rem] h-[4rem]"
                    style = {{ background: slides[index].color3 }}
                  >
                    <button
                      className="relative m-auto bg-light text-center text-[1.5rem] w-full h-full font-bold py-2 px-4 rounded-[0.4rem]"
                      style={{ color: slides[index].color1, borderColor: slides[index].color2 }}
                    >
                      Daftar sekarang!
                    </button>
                  </div>
                ...
                <div className="w-[40%] mb-[10%] flex items-center justify-center">
                  ...
                  <div
                    className="absolute top-[35rem] text-white font-bold py-2 px-4 rounded-[1.5rem] text-center w-[35%]"
                    style={{ background: slides[index].color1 }}
                    >
                    Jorem ipsum dolor
                    <br />
                    Jorem ipsum dolor
