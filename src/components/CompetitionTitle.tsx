      ...
      <div>
        <p
          className={cn(
            ...
            "mobile:text-[30px]",
            {
              "bg-gradient-to-b from-[#FB8A4A] from-14% to-[#FFE1CA] to-100% drop-shadow-orange-outline":
                theme == "orange",
            },
            {
              "bg-gradient-to-b from-[#5315B1] from-35% to-[#E31D63] to-65% drop-shadow-purple-outline":
                theme == "purple",
            },
            { "text-[35px]": children == "E-SPORT COMPETITION" },
            {
              "desktop:text-[31px] mobile:text-[26px]":
